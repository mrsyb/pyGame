...
#BLACK = 0,0,0
'''
screen = pygame.display.set_mode(size,pygame.RESIZABLE)#屏幕大小可调模式
screen = pygame.display.set_mode(size,pygame.NOFRAME)#无边框模式
'''

screen = pygame.display.set_mode(size,pygame.FULLSCREEN)#模式设置函数 参数为一个二元元组，表示窗口宽和高--pygame.RESIZABLE为屏幕可调模式
pygame.display.set_caption("pygame壁球_全屏版")#标题设置
